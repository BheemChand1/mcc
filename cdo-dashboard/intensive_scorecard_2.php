...
@media print {
    ...
    html, body, .app-wrapper, .app-main, .app-content, .container-fluid, .cts-wrap {
        background: #ffffff !important;
        padding: 0 !important;
        margin: 0 !important;
        width: 100% !important;
        ...
        <div class="container-fluid">
            ...
            <div class="filter-bar no-print">
                ...
                <div class="d-flex align-items-center gap-2 ms-auto">
                    <a href="intensive_scorecard_2_summary.php?month=<?= date('m', strtotime($fromDate)) ?>&year=<?= date('Y', strtotime($fromDate)) ?>" class="btn-filter-summary">
                            ...
                            <table class="cts-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="col-slot">Area / Part</th>
                                        <?php for ($c = 1; $c <= 24; $c++): ?>
                                            <th class="col-c th-c-head">C<?= $c ?></th>
                                        <?php endfor; ?>
                                        <th rowspan="2" class="col-ts">T.S.</th>
                                    </tr>
                                    <tr>
                                        <?php for ($c = 0; $c < 24; $c++): ?>
