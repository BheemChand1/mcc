...
// Fetch targets that overlap the selected date range - Intensive
...
// Fetch all daily reports in the range, keeping each day's shift values separate - Intensive
    ...
    <div class="app-content">
        <div class="container-fluid">
            <form class="report-filter no-print" method="GET">
                ...
                <a href="machine-target-intensive.php?month=<?= date('m', strtotime($fromDate)) ?>&year=<?= date('Y', strtotime($fromDate)) ?>" class="btn-summary" target="_blank">Machine Target</a>
                <a href="machine-summary-intensive.php?month=<?= date('m', strtotime($fromDate)) ?>&year=<?= date('Y', strtotime($fromDate)) ?>" class="btn-summary">Summary</a>
            ...
            <div class="report-wrap">
                ...
                <div class="report-frame">
                    <div class="report-header" style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #999; padding-bottom: 10px; margin-bottom: 15px;">
                        <h2 style="margin: 0;">Daily Machine Report (Intensive)</h2>
