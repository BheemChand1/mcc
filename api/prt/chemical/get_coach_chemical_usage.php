...
try {
    // 1. Get token metadata (station_id, report_date, auditor_name) - PRT
    ...
    // 2. Fetch active chemical parameters for the station - PRT
    ...
    // 3. Fetch targets active on this report date (SCD Type 2 unique bindings to prevent HY093) - PRT
    ...
    // 4. Fetch currently saved quantities - PRT
