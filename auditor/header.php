...
$auditorUser = $_SESSION['username'] ?? ($_SESSION['user_name'] ?? 'AUDITOR');
...
if (isset($page_report_mapping[$currentPage])) {
    ...
    if (!empty($assigned_reports) && !in_array($required_key, $assigned_reports)) {
        echo "<!doctype html>
        <html lang='en'>
        <head>
          <meta charset='utf-8'>
...
<head>
  ...
  <title><?php echo isset($pageTitle) ? $pageTitle : 'MCC Auditor Portal'; ?></title>
  ...
  <style>
    ...
    /* Ensure report sheets have crystal clear black/dark text on their white backgrounds */
    .report-wrap,
    .report-frame,
    .report-frame *,
    .report-container,
      ...
      <div class="container-fluid">
        ...
        <ul class="navbar-nav align-items-center">
          ...
          <li class="nav-item d-none d-sm-block ms-1">
            <span class="navbar-station-badge" style="background: rgba(14, 165, 233, 0.15); border-color: rgba(14, 165, 233, 0.4); color: #38bdf8;">
              <i class="bi bi-person-badge-fill text-info"></i>
              <span><?= htmlspecialchars($auditorUser) ?> (Auditor #<?= htmlspecialchars($currentUserId) ?>)</span>
            </span>
          </li>
          <?php endif; ?>
        </ul>
