...
$report_names['billing_management'] = $report_names['billing_management'] ?? $report_names[11] ?? 'Billing Management';

// Fallback subreport names
...
$subreport_names['pantry-chemical.php'] = $subreport_names['pantry-chemical.php'] ?? $subreport_names[23] ?? 'Pantry Car Chemical';
$subreport_names['pantry-machine.php'] = $subreport_names['pantry-machine.php'] ?? $subreport_names[24] ?? 'Pantry Car Machine';
$subreport_names['Billing.php'] = $subreport_names['Billing.php'] ?? $subreport_names[25] ?? 'Billing Invoice';
...
$has_billing      = (in_array('billing_management', $active_app_keys) || in_array(11, $active_report_ids)) && in_array('Billing.php', $active_subreport_urls);
?>
      ...
      <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation">
        ...
        <li class="nav-item <?= $isNormalActive ? 'menu-open' : '' ?>">
          <a href="#" class="nav-link <?= $isNormalActive ? 'active' : '' ?>">
            ...
            <p>
              <?= htmlspecialchars($report_names['normal_cleaning'] ?? $report_names[1] ?? 'Normal Cleaning') ?>
          ...
          <ul class="nav nav-treeview ms-3">
            ...
            <li class="nav-item">
              <a href="normal-report.php" class="nav-link <?= ($currentPage == 'normal-report.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['normal-report.php'] ?? $subreport_names[1] ?? 'Scorecard') ?></p>
              </a>
            </li>
            <?php endif; ?>
            ...
            <li class="nav-item">
              <a href="chemical-report.php" class="nav-link <?= ($currentPage == 'chemical-report.php' && !isset($_GET['intensive'])) ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['chemical-report.php'] ?? $subreport_names[2] ?? 'Chemical Report') ?></p>
              </a>
            </li>
            <?php endif; ?>
            ...
            <li class="nav-item">
              <a href="machine-report.php" class="nav-link <?= in_array($currentPage, ['machine-report.php', 'machine-target.php', 'machine-summary.php']) ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['machine-report.php'] ?? $subreport_names[3] ?? 'Machine Report') ?></p>
              </a>
            </li>
            <?php endif; ?>
          </ul>
        ...
        <li class="nav-item <?= $isIntensiveActive ? 'menu-open' : '' ?>">
          <a href="#" class="nav-link <?= $isIntensiveActive ? 'active' : '' ?>">
            ...
            <p>
              <?= htmlspecialchars($report_names['intensive_cleaning'] ?? $report_names[2] ?? 'Intensive Cleaning') ?>
              <i class="nav-arrow bi bi-chevron-right"></i>
            </p>
          </a>
          <ul class="nav nav-treeview ms-3">
            ...
            <li class="nav-item">
              <a href="intensive-report.php" class="nav-link <?= ($currentPage == 'intensive-report.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['intensive-report.php'] ?? $subreport_names[4] ?? 'Intensive Report') ?></p>
              </a>
            </li>
            <?php endif; ?>
            ...
            <li class="nav-item">
              <a href="intensive_scorecard_2.php" class="nav-link <?= in_array($currentPage, ['intensive_scorecard_2.php', 'instensive_scorecard_2.php', 'intensive_scorecard_2_summary.php']) ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['intensive_scorecard_2.php'] ?? $subreport_names[12] ?? 'Scorecard') ?></p>
              </a>
            </li>
            <?php endif; ?>
            <?php if ($has_int_chem): ?>
            <li class="nav-item">
              <a href="intensive-chemical-report.php" class="nav-link <?= in_array($currentPage, ['intensive-chemical-report.php', 'intensive-chemical-target.php', 'intensive-chemical-summary.php']) ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['intensive-chemical-report.php'] ?? $subreport_names[5] ?? 'Chemical Report') ?></p>
              </a>
            </li>
            <?php endif; ?>
            <?php if ($has_int_mach): ?>
            <li class="nav-item">
              <a href="machine-report-intensive.php" class="nav-link <?= in_array($currentPage, ['machine-report-intensive.php', 'machine-target-intensive.php', 'machine-summary-intensive.php']) ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['machine-report-intensive.php'] ?? $subreport_names[6] ?? 'Machine Report') ?></p>
              </a>
            </li>
            <?php endif; ?>
          </ul>
        ...
        <li class="nav-item <?= $isPantryActive ? 'menu-open' : '' ?>">
          <a href="#" class="nav-link <?= $isPantryActive ? 'active' : '' ?>">
            ...
            <p>
              <?= htmlspecialchars($report_names['pantry_car'] ?? $report_names[5] ?? 'Pantry Car') ?>
              <i class="nav-arrow bi bi-chevron-right"></i>
            </p>
          </a>
          <ul class="nav nav-treeview ms-3">
            ...
            <li class="nav-item">
              <a href="intensive_pantry_scorecard.php" class="nav-link <?= in_array($currentPage, ['intensive_pantry_scorecard.php', 'pantry_scorecard.php']) ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['intensive_pantry_scorecard.php'] ?? $subreport_names[13] ?? 'Pantry Car Score Card') ?></p>
              </a>
            </li>
            <?php endif; ?>
            ...
            <li class="nav-item">
              <a href="pantry-chemical.php" class="nav-link <?= ($currentPage == 'pantry-chemical.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['pantry-chemical.php'] ?? $subreport_names[23] ?? 'Chemical Report') ?></p>
              </a>
            </li>
            <?php endif; ?>
            ...
            <li class="nav-item">
              <a href="pantry-machine.php" class="nav-link <?= ($currentPage == 'pantry-machine.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['pantry-machine.php'] ?? $subreport_names[24] ?? 'Machine Report') ?></p>
              </a>
            </li>
            <?php endif; ?>
          </ul>
        ...
        <li class="nav-item <?= $isPldcActive ? 'menu-open' : '' ?>">
          <a href="#" class="nav-link <?= $isPldcActive ? 'active' : '' ?>">
            ...
            <p>
              <?= htmlspecialchars($report_names['dc_cleaning'] ?? $report_names[3] ?? 'DC Cleaning') ?>
              <i class="nav-arrow bi bi-chevron-right"></i>
            </p>
          </a>
          <ul class="nav nav-treeview ms-3">
            ...
            <li class="nav-item">
              <a href="DC-Scorecard.php" class="nav-link <?= ($currentPage == 'DC-Scorecard.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['DC-Scorecard.php'] ?? $subreport_names[7] ?? 'Scorecard') ?></p>
              </a>
            </li>
            <?php endif; ?>
            <?php if ($has_dc_chem): ?>
            <li class="nav-item">
              <a href="dc-chemical.php" class="nav-link <?= ($currentPage == 'dc-chemical.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['dc-chemical.php'] ?? $subreport_names[8] ?? 'Chemical Report') ?></p>
              </a>
            </li>
            <?php endif; ?>
            <?php if ($has_dc_mach): ?>
            <li class="nav-item">
              <a href="dc-machine.php" class="nav-link <?= ($currentPage == 'dc-machine.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['dc-machine.php'] ?? $subreport_names[9] ?? 'Machine Report') ?></p>
              </a>
            </li>
            <?php endif; ?>
          </ul>
        ...
        <li class="nav-item <?= $isPrtActive ? 'menu-open' : '' ?>">
          <a href="#" class="nav-link <?= $isPrtActive ? 'active' : '' ?>">
            ...
            <p>
              <?= htmlspecialchars($report_names['prt_cleaning'] ?? $report_names[4] ?? 'PRT Cleaning') ?>
              <i class="nav-arrow bi bi-chevron-right"></i>
            </p>
          </a>
          <ul class="nav nav-treeview ms-3">
            ...
            <li class="nav-item">
              <a href="Platform-Return-TrainsScorecard.php" class="nav-link <?= ($currentPage == 'Platform-Return-TrainsScorecard.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['Platform-Return-TrainsScorecard.php'] ?? $subreport_names[10] ?? 'Scorecard') ?></p>
              </a>
            </li>
            <?php endif; ?>
            <?php if ($has_prt_chem): ?>
            <li class="nav-item">
              <a href="Platform-Return-Chemical.php" class="nav-link <?= ($currentPage == 'Platform-Return-Chemical.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['Platform-Return-Chemical.php'] ?? $subreport_names[11] ?? 'Chemical Report') ?></p>
              </a>
            </li>
            <?php endif; ?>
            <?php if ($has_prt_mach): ?>
            <li class="nav-item">
              <a href="Platform-Return-Machine.php" class="nav-link <?= ($currentPage == 'Platform-Return-Machine.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['Platform-Return-Machine.php'] ?? $subreport_names[22] ?? 'Machine Report') ?></p>
              </a>
            </li>
            <?php endif; ?>
          </ul>
        ...
        <li class="nav-item <?= $isSurpriseActive ? 'menu-open' : '' ?>">
          <a href="#" class="nav-link <?= $isSurpriseActive ? 'active' : '' ?>">
            ...
            <p>
              <?= htmlspecialchars($report_names['surprise_visit_audits'] ?? $report_names[6] ?? 'Surprise Visit Audits') ?>
              <i class="nav-arrow bi bi-chevron-right"></i>
            </p>
          </a>
          <ul class="nav nav-treeview ms-3">
            ...
            <li class="nav-item">
              <a href="surprise-pit-office.php" class="nav-link <?= ($currentPage == 'surprise-pit-office.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['surprise-pit-office.php'] ?? $subreport_names[14] ?? 'Pit & Office Inspection') ?></p>
              </a>
            </li>
            <?php endif; ?>
            <?php if ($has_sur_pf): ?>
            <li class="nav-item">
              <a href="surprise-pf-trains.php" class="nav-link <?= ($currentPage == 'surprise-pf-trains.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['surprise-pf-trains.php'] ?? $subreport_names[15] ?? 'PF Return Trains Audit') ?></p>
              </a>
            </li>
            <?php endif; ?>
          </ul>
        ...
        <li class="nav-item <?= $isVbActive ? 'menu-open' : '' ?>">
          <a href="#" class="nav-link <?= $isVbActive ? 'active' : '' ?>">
            ...
            <p>
              <?= htmlspecialchars($report_names['vande_bharat_modules'] ?? $report_names[7] ?? 'Vande Bharat Modules') ?>
              <i class="nav-arrow bi bi-chevron-right"></i>
            </p>
          </a>
          <ul class="nav nav-treeview ms-3">
            ...
            <li class="nav-item">
              <a href="vande-bharat-report.php" class="nav-link <?= in_array($currentPage, ['vande-bharat-report.php', 'vande-bharat-summary.php']) ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['vande-bharat-report.php'] ?? $subreport_names[16] ?? 'Scorecard') ?></p>
              </a>
            </li>
            <?php endif; ?>
            <?php if ($has_vb_chem): ?>
            <li class="nav-item">
              <a href="vande-bharat-chemical.php" class="nav-link <?= in_array($currentPage, ['vande-bharat-chemical.php', 'vande-bharat-chemical-target.php', 'vande-bharat-chemical-summary.php']) ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['vande-bharat-chemical.php'] ?? $subreport_names[17] ?? 'Chemical Report') ?></p>
              </a>
            </li>
            <?php endif; ?>
            <?php if ($has_vb_mach): ?>
            <li class="nav-item">
              <a href="vande-bharat-machine.php" class="nav-link <?= in_array($currentPage, ['vande-bharat-machine.php', 'vande-bharat-machine-target.php', 'vande-bharat-machine-summary.php']) ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['vande-bharat-machine.php'] ?? $subreport_names[18] ?? 'Machine Report') ?></p>
              </a>
            </li>
            <?php endif; ?>
          </ul>
        ...
        <li class="nav-item">
          <a href="cleanliness.php" class="nav-link <?= ($currentPage == 'cleanliness.php') ? 'active' : '' ?>">
            <i class="nav-icon bi bi-stars"></i>
            <p><?= htmlspecialchars($report_names['cleanliness_modules'] ?? $report_names[9] ?? 'Cleanliness Modules') ?></p>
          </a>
        </li>
        <?php endif; ?>
        ...
        <li class="nav-item">
          <a href="photo-report.php" class="nav-link <?= ($currentPage == 'photo-report.php') ? 'active' : '' ?>">
            ...
            <p><?= htmlspecialchars($report_names['photo_reports'] ?? $report_names[10] ?? 'Photo Reports') ?></p>
          </a>
        </li>
        <?php endif; ?>
        ...
        <li class="nav-item <?= $isAttendanceActive ? 'menu-open' : '' ?>">
          <a href="#" class="nav-link <?= $isAttendanceActive ? 'active' : '' ?>">
            ...
            <p>
              <?= htmlspecialchars($report_names['attendance_manpower'] ?? $report_names[8] ?? 'Attendance & Manpower') ?>
              <i class="nav-arrow bi bi-chevron-right"></i>
            </p>
          </a>
          <ul class="nav nav-treeview ms-3">
            ...
            <li class="nav-item">
              <a href="man-power-log.php" class="nav-link <?= ($currentPage == 'man-power-log.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['man-power-log.php'] ?? $subreport_names[19] ?? 'Man Power Log') ?></p>
              </a>
            </li>
            <?php endif; ?>
            ...
            <li class="nav-item">
              <a href="biometeric_manpower_log.php" class="nav-link <?= ($currentPage == 'biometeric_manpower_log.php') ? 'active' : '' ?>">
                <p><?= htmlspecialchars($subreport_names['biometeric_manpower_log.php'] ?? $subreport_names[26] ?? 'Bio Metric') ?></p>
              </a>
            </li>
            <?php endif; ?>
          </ul>
        ...
        <li class="nav-item">
          <a href="Billing.php" class="nav-link <?= ($currentPage == 'Billing.php') ? 'active' : '' ?>">
            ...
            <p><?= htmlspecialchars($subreport_names['Billing.php'] ?? $subreport_names[25] ?? 'Billing Invoice') ?></p>
          </a>
        </li>
        <?php endif; ?>
