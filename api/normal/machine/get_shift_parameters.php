...
try {
    // 1. Get shift name
    $shiftStmt = $pdo->prepare("SELECT shift AS shift_name FROM mcc_normal_machine_shifts WHERE id = :shift_id LIMIT 1");
    ...
    // 2. Fetch active machines for this station
    ...
    // 3. Fetch targets/nominations active on this report date (SCD Type 2 range query with HY093 safety)
