...
// Fetch report data for selected date - Intensive
    ...
    <div class="app-content">
        <div class="container-fluid">
            <form class="report-filter no-print" method="GET">
                ...
                <a href="machine-target-intensive.php?target_month=<?= date('Y-m', strtotime($fromDate)) ?>" class="btn-summary" target="_blank">Machine Target</a>
