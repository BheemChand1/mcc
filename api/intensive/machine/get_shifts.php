...
try {
    ...
    // 2. Fetch active nominations for this station on this report date (SCD Type 2 with HY093 safety) - Intensive
    ...
    // 3. Fetch existing reports for this station on this date - Intensive
