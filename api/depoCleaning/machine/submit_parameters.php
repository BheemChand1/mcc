...
try {
    ...
    // Prepare statements for DC machine report
    $checkStmt = $pdo->prepare("
        SELECT id FROM dc_mcc_machine_report 
    ...
    echo json_encode([
        "status" => "success",
        "message" => "DC Machine report parameters submitted successfully.",
        "token_id" => $tokenId,
