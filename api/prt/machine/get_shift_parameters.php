...
try {
    // 1. Get shift name - PRT
    $shiftStmt = $pdo->prepare("SELECT shift AS shift_name FROM mcc_prt_machine_shifts WHERE id = :shift_id LIMIT 1");
    ...
    // 2. Fetch active machines for this station - PRT
    ...
    // 3. Fetch targets/nominations active on this report date (SCD Type 2 range query with HY093 safety) - PRT
    ...
    // 4. Fetch existing report records and token - PRT
