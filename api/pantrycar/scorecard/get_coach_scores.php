...
try {
    // 1. Fetch scores joined with parameter details for the specific coach in Pantry Car Scorecard
    $stmt = $pdo->prepare("
        SELECT 
            ...
            sp.input_type,
            r.score_value,
            r.submitted_by AS auditor_name,
            r.report_date
    ...
    if (empty($ratingsRows)) {
        // Fallback to normal rating table if needed
