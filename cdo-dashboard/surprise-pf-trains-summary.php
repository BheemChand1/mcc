...
// Fetch active parameters of category 'pf_trains' to get total max marks
...
$reportsStmt = $pdo->prepare("
    ...
    WHERE r.station_id = :station_id AND r.category = 'pf_trains' AND r.report_date BETWEEN :start_date AND :end_date
...
$pageTitle = 'MCC | Platform & Trains Surprise Visit Monthly Summary';
    ...
    <div class="container-fluid">
      ...
      <div class="card shadow-sm border-0 mb-4 bg-white no-print">
        <div class="card-body p-3 col-md-8 mx-auto">
          <form method="GET" action="surprise-pf-trains-summary.php" class="row g-3 align-items-center justify-content-center">
            <div class="col-auto">
      ...
      <div class="card border-0 bg-white shadow-sm" style="border-radius: 12px; overflow: hidden; border: 1px solid #e2e8f0;">
        <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between flex-wrap gap-2">
          <h5 class="mb-0 font-weight-bold text-dark d-flex align-items-center">
            ...
            Platform & Trains Surprise Visit Summary: <?= date('F Y', strtotime($startDate)); ?>
          </h5>
                  ...
                  <tr class="<?= $bgClass; ?>">
                    ...
                    <td class="text-center no-print">
                      ...
                      <?php else: ?>
                        <?php foreach ($daySheets as $ds): ?>
                          <div class="mb-1">
                            <a href="surprise-pf-trains.php?from_date=<?= $ds['report_date']; ?>&to_date=<?= $ds['report_date']; ?>" class="btn btn-xs btn-outline-primary py-0 px-2 fw-bold" style="font-size: 0.78rem;">
