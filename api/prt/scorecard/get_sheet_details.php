...
try {
    ...
    // 3. Fetch active parameters and subparameters - PRT
    ...
    // Fetch all rating options grouped by rating_group - PRT
    ...
    // 4. Fetch current scorecard scores - PRT
